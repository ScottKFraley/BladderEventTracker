...
export class ApplicationInsightsService {
  ...
  constructor(private router: Router, private envService: EnvironmentService) {
    ...
    // Get connection string from environment service (runtime) or fallback to build-time environment
    const connectionString = this.envService.getApplicationInsightsConnectionString() || 
